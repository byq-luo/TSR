...
model = Model(inpt,x,name='Multichannel')  
model.compile(loss='categorical_crossentropy',optimizer='sgd',metrics=['accuracy'])  


model.summary()  

tb = TensorBoard(log_dir='./mc_data3_logs', histogram_freq=1, write_graph=True, write_images=False, embeddings_freq=0,
					embeddings_layer_names=None, embeddings_metadata=None)
#model_checkpoint = ModelCheckpoint('mc_weights.hdf5', monitor='loss', verbose=1, save_best_only=True)
...
model.save_weights('mc_weights3.hdf5')
